...
public abstract class PaginationInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        Page pagingBounds = (Page) readField(handler, FIELD_ROWBOUNDS);
    ...
    private void getTotalAndSetInPagingBounds(String targetSql, BoundSql boundSql, Page bounds, 
    ...
    protected abstract String getSelectPagingSql(String targetSql, Page pagingBounds);
    ...
    public Object plugin(Object target) {
        if (target instanceof RoutingStatementHandler) {
            try {
                ...
                if (rowBounds != RowBounds.DEFAULT && rowBounds instanceof Page) {
