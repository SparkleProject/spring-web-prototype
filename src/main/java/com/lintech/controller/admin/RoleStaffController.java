...
public class RoleStaffController{
    ...
    public Object init(HttpServletRequest request,HttpServletResponse response){
        ...
        Page<RoleStaff> result = roleStaffService.findAll(pageable);
        DataGrid<RoleStaff> datagrid = new DataGrid<RoleStaff>(result.getContent(), (int) result.getTotalElements());
        return datagrid;
    }
    ...
    public Object all(HttpServletRequest request,HttpServletResponse response){
        ...
        DataGrid<RoleStaff> datagrid=new DataGrid<RoleStaff>(roleStaffList, roleStaffList.size());
        return datagrid;
    }
